...
#SBATCH --output=/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/logs/TrainingModelXVI_%j.out  # Chemin absolu
#SBATCH --error=/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/logs/TrainingModelXVI_%j.err    # Chemin absolu
