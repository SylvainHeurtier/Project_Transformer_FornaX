...
global_stats_Xamin, global_stats_input_clusters, global_stats_input_AGN = \
    process_rotations_in_chunks(list_windows_test, 
                            ...
                            chunk_size=300, 
                            output_dir = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/rotation_output_test",
...
global_stats_Xamin, global_stats_input_clusters, global_stats_input_AGN = \
    process_rotations_in_chunks(list_windows_train, 
                            ...
                            total_rotations=30000, 
                            chunk_size=300, 
                            output_dir = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/rotation_output_train",
                            stats_Xamin = global_stats_Xamin, 
                            stats_input_clusters = global_stats_input_clusters, 
                            stats_input_AGN = global_stats_input_AGN)
...
process_and_save_chunks(
    directory   = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/rotation_output_test",
    output_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/X_test.txt",
    stats_Xamin          = global_stats_Xamin,
    stats_input_clusters = global_stats_input_clusters,
    stats_input_AGN      = global_stats_input_AGN,
    max_sources  = MAX_SOURCES,
...
process_and_save_chunks(
    directory   = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/rotation_output_train",
    output_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/X_train.txt",
    stats_Xamin          = global_stats_Xamin,
    stats_input_clusters = global_stats_input_clusters,
    stats_input_AGN      = global_stats_input_AGN,
    max_sources  = MAX_SOURCES,
...
# Sauvegarde en JSON
save_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/constantes_du_modele.json"
...
save_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/global_stats_Xamin.json"
with open(save_path, 'w') as f:
    json.dump(global_stats_Xamin, f, indent=4)
print(f"Dictionnaire sauvegardé dans {save_path}")

save_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/global_stats_input_clusters.json"
with open(save_path, 'w') as f:
...
save_path = f"/lustre/fswork/projects/rech/wka/ufl73qn/Transformer_Window_Center_Classifier/results/{name_dir}/global_stats_input_AGN.json"
with open(save_path, 'w') as f:
