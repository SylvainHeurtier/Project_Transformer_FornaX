...
output_path = os.path.expanduser(f'/lustre/fswork/projects/rech/wka/ufl73qn/Project_Transformer_FornaX/Transformer_Window_Catalog/results/{name_dir}/{output_filename}')
